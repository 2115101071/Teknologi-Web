...
2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"></path></svg>
                                            </div>
                                ...
                                <button type = "button" class="inline-block mx-4 px-6 py-2 border2 border-blue-600 text-blue-600 font-medium text-xs leading-tight uppercase rounded-rmd 
                                hover:bg-indigo-100 hover:bg-opacity-5 focus:outline-none focus:ring-0 transition 
                                duration150 ease-in-out">Check</button>
                            </div>
                        </div>
                        ...
                        <section>
                            <div class="md:flex font-sans pt-8">
                                ...
                                <form class="p-6">
                                    ...
                                    First, one of the mostvisited tourist attractions in Bali is Ubud, visited by either local or international tourists. Ubud Bali tourist attraction has astonished many visitors who always want to return
                                    </div>
                                    <div class="flex space-x-4 mb-5 text-sm font-medium">
                                        ...
                                        <button class="flex-none flex items-center justify-center w-9 h9 rounded-full text-violet-600 bg-violet-50" type="button" aria-label="Like"><svg width="20" height="20" fill="currentColor" ariahidden="true">
                                        <path fill-rule="evenodd" cliprule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" /></svg>
                                        </button>
                                    </div>
                            ...
                            <div class="md:flex font-sans pt-8">
                                ...
                                <form class="p-6">
                                    ...
                                    <div classs="w-full flex-none mt-2 pr-4 order-1 text-3xl fontbold text-violet-600 mr-2">
                                    Rp. 150.000
                                    </div>
                                    <div class = "text-sm font-medium text-slate-400">
                                        Available
                            ...
                            <div class=" font-sans pt-8 text-center"><a href="#" class="inline-flex items-center py-2 px-4 text-sm fontmedium text-gray-500 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 hover:textgray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray700 dark:hover:text-white">
                                Previous 
                            </a>
                            <!-- Next Button -->
